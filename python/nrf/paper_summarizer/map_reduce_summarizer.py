...
class MapReduceSummarizer(PaperSummarizer):
    def __init__(self,
                 models: Sequence[str],
                 num_keywords: int,
                 max_tokens: int,
                 num_map_reduce_tokens: int,
        ...
        self._num_map_reduce_tokens = num_map_reduce_tokens
    ...
    def _build_map_reduce_graph_chain(self,
                                      map_reduce_prompt: str
                                      ) -> Runnable:
    ...
    def _run_map_reduce_graph(self, content: str) -> str:
        ...
        splitter = RecursiveCharacterTextSplitter(
            chunk_size=int(self._num_map_reduce_tokens / 2),
            chunk_overlap=0,
        )
    ...
    def _should_collapse(self, state: OverallState
        ...
        return  (
            "collapse_summaries"
            if num_tokens > self._num_map_reduce_tokens else
            "generate_final_summary"
        )
